...
package com.zealp.benchmark_ui.widget.preview.view;
...
import com.zealp.benchmark_ui.widget.photoview.PhotoView;
...
public class SmoothImageView extends PhotoView {
    ...
    private void initTransform() {
        ...
        startTransform.top = thumbRect.top - CommonUtils.getStatusBarHeight(getContext());
