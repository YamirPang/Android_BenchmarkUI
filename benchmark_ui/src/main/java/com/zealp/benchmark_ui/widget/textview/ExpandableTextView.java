package com.zealp.benchmark_ui.widget.textview;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getDrawable(getContext(), R.drawable.benchmarkui_ic_expand_more_black_12dp);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.drawable.benchmarkui_ic_expand_less_black_12dp);
        }
        typedArray.recycle();
    }
