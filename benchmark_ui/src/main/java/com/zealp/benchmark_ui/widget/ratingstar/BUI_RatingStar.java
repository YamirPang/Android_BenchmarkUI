package com.zealp.benchmark_ui.widget.ratingstar;
 ...
 */
public class BUI_RatingStar extends View implements View.OnClickListener{

    public final int CLIP_SAVE_FLAG = 0x02;//需要还原Clip
    ...
    private OnRatingStarTouchListener mOnRatingStarTouchListener;

    public interface OnRatingStarTouchListener{
        void getRating(float rating);
    }

    public void setmOnRatingStarTouchListener(OnRatingStarTouchListener mOnRatingStarTouchListener) {
        this.mOnRatingStarTouchListener = mOnRatingStarTouchListener;
    }

    // region constructors
    public BUI_RatingStar(Context context) {
        super(context);
        init(null, 0);
    }

    public BUI_RatingStar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public BUI_RatingStar(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void loadAttributes(AttributeSet attrs, int defStyle) {
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.BUI_RatingStar, defStyle, 0);
        strokeColor = a.getColor(R.styleable.BUI_RatingStar_strokeColor, strokeColor);
        starForegroundColor = a.getColor(R.styleable.BUI_RatingStar_starForegroundColor, starForegroundColor);
        starBackgroundColor = a.getColor(R.styleable.BUI_RatingStar_starBackgroundColor, starBackgroundColor);
        cornerRadius = a.getDimension(R.styleable.BUI_RatingStar_cornerRadius, cornerRadius);
        starMargin = a.getDimension(R.styleable.BUI_RatingStar_starMargin, starMargin);
        strokeWidth = a.getDimension(R.styleable.BUI_RatingStar_strokeWidth, strokeWidth);
        starThicknessFactor = a.getFloat(R.styleable.BUI_RatingStar_starThickness, starThicknessFactor);
        rating = a.getFloat(R.styleable.BUI_RatingStar_rating, rating);
        starNum = a.getInteger(R.styleable.BUI_RatingStar_starNum, starNum);
        drawStrokeForEmptyStar = a.getBoolean(R.styleable.BUI_RatingStar_drawStrokeForEmptyStar, true);
        drawStrokeForFullStar = a.getBoolean(R.styleable.BUI_RatingStar_drawStrokeForFullStar, false);
        drawStrokeForHalfStar = a.getBoolean(R.styleable.BUI_RatingStar_drawStrokeForHalfStar, true);
        enableSelectRating = a.getBoolean(R.styleable.BUI_RatingStar_enableSelectRating, false);
        onlyHalfStar = a.getBoolean(R.styleable.BUI_RatingStar_onlyHalfStar, true);
        a.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mOnRatingStarTouchListener != null)
            mOnRatingStarTouchListener.getRating(rating);
    }
