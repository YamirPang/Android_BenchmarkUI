package com.zealp.benchmark_ui.widget.textview.supertextview;
    ...
    private void initCenterTextView() {
        if (mEnableEdit) {
            ...
            if (mEditBackground != null) {
                ...
                mCenterEditText.setBackgroundColor(ResUtils.getColor(R.color.benchmarkui_config_color_transparent));
            }
