 ...
 */
public abstract class BaseCustomIndicatorBanner<E, T extends BaseCustomIndicatorBanner<E, T>> extends BaseCustomBanner<E, T> {
    ...
    public BaseCustomIndicatorBanner(Context context) {
        super(context);
        initAttrs(context, null);
    }

    public BaseCustomIndicatorBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
    }

    public BaseCustomIndicatorBanner(Context context, AttributeSet attrs, int defStyle) {
