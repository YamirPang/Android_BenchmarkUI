...
public class ChrysanthemumLoadingView extends View {
    ...
    public ChrysanthemumLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.ChrysanthemumLoadingStyle);
    }

    public ChrysanthemumLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(context, attrs, defStyleAttr);
        initPaint();
    }

    public ChrysanthemumLoadingView(Context context, int size, int color) {
        super(context);
        mSize = size;
        mPaintColor = color;
        initPaint();
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.ChrysanthemumLoadingView, defStyleAttr, 0);
        mSize = array.getDimensionPixelSize(R.styleable.ChrysanthemumLoadingView_chrysanthemum_turn_view_size, DensityUtils.dp2px(context, 16));
        mPaintColor = array.getColor(R.styleable.ChrysanthemumLoadingView_chrysanthemum_turn_view_color, Color.BLACK);
        array.recycle();
    }
