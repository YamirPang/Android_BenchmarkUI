...
package com.zealp.benchmark_ui.widget.preview.ui;
...
import com.zealp.benchmark_ui.widget.preview.MediaLoader;
...
import com.zealp.benchmark_ui.widget.preview.view.BezierBannerView;
import com.zealp.benchmark_ui.widget.preview.view.PhotoViewPager;
import com.zealp.benchmark_ui.widget.preview.view.SmoothImageView;
...
public class PreviewActivity extends FragmentActivity {
    ...
    /*** 图片的地址***/
    private List<IImagePreview> mImgUrls;
    /*** 当前图片的位置 ***/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initArgs();
        if (getLayoutId() == 0) {
            setContentView(R.layout.preview_act_image_photo);
        } else {
     ...
     **/
    protected void iniFragment(List<IImagePreview> imgUrls, int currentIndex, Class<? extends BasePhotoFragment> className) {
        if (imgUrls != null) {
    ...
    private void initView() {
        ...
        if (mType == PreviewBuilder.IndicatorType.Dot) {
            ...
            mTvIndex.setText(getString(R.string.benchmark_ui_preview_count_string, (mCurrentIndex + 1), mImgUrls.size()));
            mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                ...
                public void onPageSelected(int position) {
                    //当被选中的时候设置小圆点和当前位置
                    if (mTvIndex != null) {
                        mTvIndex.setText(getString(R.string.benchmark_ui_preview_count_string, (position + 1), mImgUrls.size()));
                    }
