 ...
 * @param <T>
 */
public abstract class BenchmarkUIListAdapter<T> extends BaseAdapter {
	private List<T> mData = new ArrayList<>();
	private OnListItemListener<T> mOnListItemListener;
	private Context mContext;

	public BenchmarkUIListAdapter(Context context) {
		mContext = context;
	}

	public BenchmarkUIListAdapter(Context context, OnListItemListener<T> callback) {
		this(context);
		mOnListItemListener = callback;
	}

	public BenchmarkUIListAdapter(Context context, List<T> data) {
		mContext = context;
		setData(data);
	}

	public BenchmarkUIListAdapter(Context context, T[] data) {
		mContext = context;
		setData(data);
	}
